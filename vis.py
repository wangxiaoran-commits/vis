...
# 取以2为底的log
data_avg_concentration['LogAverageConcentration'] = np.log(data_avg_concentration['AverageConcentration'] + 1) / np.log(2)
...
#作图
heatmap = sns.heatmap(pivot_data_avg_concentration_log, annot=True, cmap=cmap, fmt=".2f", linewidths=.5, cbar_kws={'label': 'Log2(Average Concentration (ug/kg))'},annot_kws={"fontsize": 9})
...
colorbar.set_label('Log2(Average Concentration (ug/kg))', fontsize=15)  # 图例标题字体大一些
# 调整布局
