...
# 取以2为底的log
data_avg_concentration['LOG_ProbofAntiForM'] =data_avg_concentration['ProbofAntiForM']
...
#作图
heatmap = sns.heatmap(pivot_data_avg_concentration_log, annot=True, cmap=cmap, fmt=".2f", linewidths=.5, cbar_kws={'label': 'LOG_ProbofAntiForM'},annot_kws={"fontsize": 9})
...
colorbar.set_label('LOG_ProbofAntiForM', fontsize=15)  # 图例标题字体大一些
# 调整布局
